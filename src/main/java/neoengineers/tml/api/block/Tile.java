package neoengineers.tml.api.block;
...
public class Tile extends TileEntity implements ISidedInventory {
	...
	public Container getContainer(InventoryPlayer playerInventory){
			return new neoengineers.tml.api.block.Container(playerInventory, this);
	}

	public Gui getGui(InventoryPlayer playerInventory){
		return new neoengineers.tml.api.block.Gui(playerInventory, this);
	}
}